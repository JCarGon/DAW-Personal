...
/* Modifique el nombre de la vista listado_pagos_clientes y asígnele el nombre listado_de_pagos. Una vez que haya modificado el nombre de la vista 
...
(utilizando el comando show tables), o de la pantalla del phpMyAdmin. DESPUES elimine las vistas que ha creado en los pasos anteriores.
